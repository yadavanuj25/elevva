...
//     theme="custom"
//   >
//     <div className="relative  flex justify-center items-center px-2 py-2 border border-gray-300 dark:border-gray-600 text-sm rounded-r-md cursor-pointer">
//       {icon}
//       {badge && (
...
const ToolTip = ({ title, icon, badge, placement = "top" }) => (
  <Tippy
    content={title}
    placement={placement}
    arrow={true}
