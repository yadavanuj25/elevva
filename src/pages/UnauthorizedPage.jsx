...
const UnauthorizedPage = () => {
  return (
    <div className="relative min-h-[80vh] flex items-center justify-center overflow-hidden">
      <div className="relative z-10 backdrop-blur-xl bg-white dark:bg-gray-700 border border-[#E8E8E9] dark:border-gray-600  rounded-3xl p-10 max-w-lg text-center animate-fadeIn">
